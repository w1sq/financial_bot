...
"""
ТЗ по свечам + следующее:

+ рассматриваем только те свечи, для которых её размер - не менее 1.5% от цены

+ дополнительно выделить: хорошая свеча длина более 2% от цены (минимума или максимума)

+ даем инфу, если объём изменился более чем в 2 раза от:
-предыдущего дня
-среднего за 3 дня
-среднего за 5 дней


+ выделить: свеча "эскимо - большое зеленое тело, средняя-большая нижняя тень, маленькая верхняя тень"

+ посмотреть: тело в четверть для молотов и звезд (цвет неважен) (для молотов и звезд - тело + маленькая тень не более четверти)

? паттерн двухдневной (3 свеча в тз) - интересно посмотреть, на те случаи, когда объем торгов первой свечи меньше объёма торгов на второй


на подумать, под вопросом: 
    1) как выдавать "качество" получаемого сигнала (например - хорошая свеча это плюсик, хорошая свеча и объём - два плюсика)
    *2) 'эскимо' - сигнал хороший на "развороте", в продолжении тренда - плохой, как выделить тренд корректно?
"""
