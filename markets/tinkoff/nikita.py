            ...
            if (
                ...
                if order.lots_executed > 0:
                    ...
                    messages_to_send.append(
                        "СТРАТЕГИЯ НИКИТЫ v 1.1 ПОКУПКА\n\n" + purchase_text
                    )
